...
const LpListPage = () => {
    ...
    <div className="p-6 bg-black min-h-full">
        ...
        className="fixed bottom-10 right-10 w-12 h-12 bg-[#FF2D86] rounded-full flex items-center justify-center text-white text-3xl shadow-lg z-50 active:scale-90 transition-transform"
        >
        +
        </button>
            <LpAddModal 
